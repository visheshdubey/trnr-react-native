    ...
    <View style={{ backgroundColor: 'white' }}>
      <ScrollView style={{ padding: 10, alignSelf: 'center', width: Mixins.scaleSize(370) }}>
        <View style={{ marginBottom: 150 }}>
          ...
          <Text style={{ fontSize: Typography.FONT_SIZE_18, fontFamily: Typography.FONT_FAMILY_BODY, paddingLeft: 15 }}>
            (a) New Era Fitness Pty Ltd will, from time to time, receive and store personal information you enter onto our software application TRNR, provide to us directly or give to us in other
            forms. {'\n'}
          </Text>
          <Text style={{ fontSize: Typography.FONT_SIZE_18, fontFamily: Typography.FONT_FAMILY_BODY, paddingLeft: 15 }}>
          ...
          <Text style={{ fontSize: Typography.FONT_SIZE_18, fontFamily: Typography.FONT_FAMILY_BODY, paddingLeft: 15 }}>
            (a) We may disclose your personal information to any of our employees, officers, insurers, professional advisers, agents, suppliers or subcontractors insofar as reasonably necessary for
            the purposes set out in this Policy. Personal information is only supplied to a third party when it is required for the delivery of our services. {'\n'}
          </Text>
          <Text style={{ fontSize: Typography.FONT_SIZE_18, fontFamily: Typography.FONT_FAMILY_BODY, paddingLeft: 15 }}>
