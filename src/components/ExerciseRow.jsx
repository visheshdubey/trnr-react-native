  ...
  return (
    <View style={[styles.container, style]}>
      <TouchableOpacity style={styles.card1} onPress={onPress}>
        <Image style={styles.imageStyles} source={image} resizeMode="contain"></Image>
        <Image style={styles.backdrop} source={backdrop} resizeMode="cover"></Image>
        <View style={[styles.backdrop]}>
          <Text style={[styles.text, { fontSize: Typography.FONT_SIZE_16 }]}>{categoryName}</Text>
          <Text style={[styles.text, { fontSize: Typography.FONT_SIZE_24 }]}>{exerciseName1}</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity style={styles.card2} onPress={onPress}>
        ...
        <View style={[styles.backdrop]}>
          <Text style={[styles.text, { fontSize: Typography.FONT_SIZE_16 }]}>{categoryName}</Text>
          <Text style={[styles.text, { fontSize: Typography.FONT_SIZE_24 }]}>{exerciseName2}</Text>
        </View>
      </TouchableOpacity>
    </View>
  );
